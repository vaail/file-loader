...
|**`publicPath`**|`{String\|Function}`|`undefined`|Configure a custom `public` path for your files|
|**`outputPath`**|`{String\|Function}`|`''`|Configure a custom `output` path for your files|
